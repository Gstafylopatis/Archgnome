...
sudo pacman -S --noconfirm --needed galculator gimp git gksu gnome-disk-utility 
...
sudo pacman -S --noconfirm --needed thunar transmission-cli transmission-gtk tumbler
